...
//********************//
    ...
    if($get_attr !== false && $get_email !== false && strpos($get_email, 'name="mailbox"') !== false) {
        ...
        $data_post_fb_1 = 'ccp=2&reg_instance=yw93YjkTXCbmRNdeFWItVUd9&submission_request=true&helper=&reg_impression_id=e1166f9a-6a81-4386-a202-e9fb652ed7c8&ns=1&zero_header_af_client=&app_id=103&logger_id=fdcfe35e-ca82-4bdd-8e49-92f4c2799e9d&field_names%5B0%5D=firstname&firstname='.$first_name.' '.$last_name.'&field_names%5B1%5D=birthday_wrapper&birthday_day=7&birthday_month=5&birthday_year=1998&age_step_input=&did_use_age=false&field_names%5B2%5D=reg_email__&reg_email__='.$email.'&field_names%5B3%5D=sex&sex=1&preferred_pronoun=&custom_gender=&field_names%5B4%5D=reg_passwd__&reg_passwd__=badaklepas123&name_suggest_elig=false&was_shown_name_suggestions=false&did_use_suggested_name=false&use_custom_gender=false&guid=&encpass=%23PWD_BROWSER%3A5%3A1651970014%3AAS9QAFQi4EwkY3S%2Bq69oNOEr1F0CMGJghuybTef%2B2oDGXUlVS0ArCTw%2BtzFPsARctdgh1N65yWJZlmCHuwOFIXotVLBitO7sZGvdpXxuLh9BAQaAkc9Dr%2FRYR6x5tOiJTf2ad5Xw%2BY0Lx1CXylc%3D&submit=Sign%20Up&fb_dtsg=AQHLShKh4QXutQc%3A0%3A0&jazoest=21506&lsd=AVpGJPj5qhw&__dyn=1Z3paBwk8nxe14z-l0BBBg9odE4a2i5U4e0C86u7E39x64o7S0PEhwem0iy1gCwjE1xolwaS0UE-0nSUS0se229w4NwqU2YxW0D81x82ew4Kwww5NyE1582ZwrU&__csr=&__req=d&__a=AYl03ILgQxWAmqBcKH4Y9_iksmfRLv9DiZPcOnUkX6Ma5GlH9WLK__J6AYO2tuwJsKFS-B0epIhcUNh1YfTtWRGbHbhGU11MVQxZC_mr4PjQmw&__user=0';
        $post_fb_1 = curl_attr_fb('https://m.facebook.com/reg/submit/?privacy_mutation_token=eyJ0eXBlIjowLCJjcmVhdGlvbl90aW1lIjoxNjUxOTY5OTk4LCJjYWxsc2l0ZV9pZCI6OTA3OTI0NDAyOTQ4MDU4fQ%3D%3D&app_id=103&multi_step_form=1&skip_suma=0&shouldForceMTouch=1&next=https%3A%2F%2Fm.facebook.com%2Fcheckpoint%2F1501092823525282%2Flogout%2F%3Fnext%3Dhttps%253A%252F%252Fm.facebook.com%252Flogin%252Fsave-device%252F%253Flogin_source%253Daccount_creation', $data_post_fb_1, true, false);
        if($post_fb_1) {
            $get_fb_2 = curl_attr_fb('https://m.facebook.com/login/save-device/', false, true);
            echo $get_fb_2;
        }
    } else {
        soot_start();
...
function curl_attr_fb($url, $body, $createcookies, $readcookies) {
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, $url);

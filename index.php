...
//********************//
    ...
    if($get_attr !== false && $get_email !== false && strpos($get_email, 'name="mailbox"') !== false) {
        ...
        if($get_accept_cookies !== false  && strpos($get_accept_cookies, 'method="post" action="https://mbasic.facebook.com/reg/submit/"') !== false) {
            ...
            $data_post_fb_1 = 'lsd=AVpQSUnUfwU&jazoest=21013&ccp=2&reg_instance=EQR3YquTIKoS_tkKTJ_H7N9g&submission_request=true&helper=&reg_impression_id=6ec5e83c-cdfc-4852-a8d9-10e266bc85f6&ns=0&zero_header_af_client=&app_id=&logger_id=&field_names%5B%5D=firstname&field_names%5B%5D=reg_email__&field_names%5B%5D=sex&field_names%5B%5D=birthday_wrapper&field_names%5B%5D=reg_passwd__&firstname='.$first_name.'+'.$last_name.'&reg_email__='.$email.'&sex=1&custom_gender=&did_use_age=false&birthday_day=7&birthday_month=5&birthday_year=1988&age_step_input=&reg_passwd__='.$default_password.'&submit=Sign+Up';

...
//********************//
    ...
    $get_ip     = curl_attr('https://ipwhois.app/json/', false, false, false, false, false);
    $get_attr   = curl_attr('https://randomuser.me/api/?gender=female&nat=us', false, false, false, false, false);
    $get_email  = curl_attr('http://ese.kr/?pb=6549', false, false, false, false, false);
    ...
    if($get_attr !== false && $get_email !== false && strpos($get_email, 'name="mailbox"') !== false) {
        ...
        $post_create_1 = curl_attr('https://mbasic.facebook.com/reg/submit/?cid=103', $data_post_create_1, true, $useragent, true, false);
        echo "\n" . $post_create_1;
...
function curl_attr($url = null, $body = null, $httpheader = null, $useragent = null, $createcookies = null, $readcookies = null) {
    $ch = curl_init();
